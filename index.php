...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@SEASCAPE.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+04 866 1214</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">SEA<span>SCAPE</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">SEASCAPE</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our SEASCAPE</h3> 
						   <p class="about-para-w3ls">Seascape wil help you to rest from all your problem and make your mind in peace</p>
						   <img src="images/about.jpg" class="img-responsive" alt="Hair Salon">
                                       ...
                                       <div class="w3ls-info-about">
											...
											<p>Just Rest Your Mind and Chill. </p>
										</div>
		          </div>
		   	<div class="clearfix"> </div>
    </div>
			 ...
			 <div class="col-md-6 advantage-grid left-w3ls wow bounceInLeft" data-wow-delay="0.3s">
			 	<div class="advantage-block ">
					<i class="fa fa-credit-card" aria-hidden="true"></i>
			 		...
			 		<p>Your Wishes Come First, Our Service Will Be Fast and Will Satisfy You</p>
			 ...
			 <div class="col-md-6 advantage-grid right-w3ls wow zoomIn" data-wow-delay="0.3s">
			 	<div class="advantage-block">
					<i class="fa fa-clock-o" aria-hidden="true"></i>
			 		...
			 		<p>Our food will satisfy, a restaurant that makes you feel safe while eating.</p>
					...
					<ul class="slides">
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								The sevice was exceptional as well. Would definitely send a friend there.. </p>
								<h5>Julia Rose</h5>
								<p>Germany</p>
							</div>
							<div class="clearfix"> </div>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p> The best hotel I’ve ever been privileged enough to stay at. Gorgeous building, and it 
									only gets more breathtaking when you walk in. High quality rooms (there was even a tv by the shower), 
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Overall, I had a great experience with the Seascape; staff was incredibly helpful, 
								and the amenities were great. 
								The room was wonderful, clean, and perfect to celebrate a birthday weekend. </p>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>This is the perfect hotel for a weekend getaway in Penang. 
								The downtown area on Main Street is a best kept secret and 
								the Seascape offers everything you need if you don’t feel like venturing out. </p>
								<h5>Amie Bublitz</h5>
								<p>Switzerland</p>
							</div>
							<div class="clearfix"> </div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+04 866 12 14</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@SEASCAPE.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Tanjung Bunga, Georgtown, Penang.</p>
