        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="messages.php"><i class="fa fa-desktop"></i> News Letters & Message </a>
                    </li>
					<li>
			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                           News letters & Message <small> panel</small>
                        </h1>
                    </div>
                </div> 
                 <!-- /. ROW  -->
			   ...
			   ?>
                ...
                <div class="col-md-12">
                    <div class="jumbotron">
						...
						<h3>Receive The Message from the Followers</h3>
						<?php
